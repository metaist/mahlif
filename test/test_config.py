...
class TestFindConfigFile:
    ...
    def test_finds_mahlif_toml(self, tmp_path: Path) -> None:
    ...
    def test_finds_pyproject_with_mahlif_section(self, tmp_path: Path) -> None:
    ...
    def test_ignores_pyproject_without_mahlif(self, tmp_path: Path) -> None:
    ...
    def test_prefers_mahlif_toml_over_pyproject(self, tmp_path: Path) -> None:
...
class TestLoadConfig:
    ...
    def test_loads_mahlif_toml(self, tmp_path: Path) -> None:
...
"""
    ...
    def test_returns_defaults_for_invalid_toml(self, tmp_path: Path) -> None:
...
class TestParseLintConfig:
    ...
    def test_handles_non_list_values(self) -> None:
...
class TestDataclasses:
    ...
    def test_lint_config_defaults(self) -> None:
