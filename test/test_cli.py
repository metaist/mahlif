...
# ----------------------------------------------------------------------
# TestMainCLI: Tests for main CLI entry point.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# TestConvertCommand: Tests for convert command.
# ----------------------------------------------------------------------


def test_source_not_found(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_mahlif_to_sibelius(capsys: pytest.CaptureFixture[str], tmp_path: Path) -> None:
...
def test_mahlif_to_lilypond(capsys: pytest.CaptureFixture[str], tmp_path: Path) -> None:
...
# ----------------------------------------------------------------------
# TestStatsCommand: Tests for stats command.
# ----------------------------------------------------------------------
...
def test_basic_stats(capsys: pytest.CaptureFixture[str], tmp_path: Path) -> None:
...
def test_json_output(capsys: pytest.CaptureFixture[str], tmp_path: Path) -> None:
...
def test_verbose_output(capsys: pytest.CaptureFixture[str], tmp_path: Path) -> None:
...
# ----------------------------------------------------------------------
# TestStatsModule: Tests for stats module functions.
# ----------------------------------------------------------------------


def test_compute_stats_empty_score() -> None:
...
def test_compute_stats_bar_without_notes() -> None:
...
def test_compute_stats_uncounted_element_types() -> None:
...
def test_compute_stats_with_elements() -> None:
                ...
                bars=[
                    Bar(
                        ...
                        elements=[
                            ...
                            NoteRest(pos=256, dur=256, notes=[Note(pitch=62)]),  # note
...
def test_format_stats_minimal() -> None:
...
def test_format_stats_verbose() -> None:
...
def test_stats_main_direct(tmp_path: Path) -> None:
