...
# ----------------------------------------------------------------------
# TestPitchConversion: Test pitch to LilyPond conversion.
# ----------------------------------------------------------------------
...
def test_with_accidentals() -> None:
...
def test_unknown_accidental() -> None:
...
# ----------------------------------------------------------------------
# TestDurationConversion: Test duration to LilyPond conversion.
# ----------------------------------------------------------------------


def test_standard_durations() -> None:
...
def test_unknown_durations() -> None:
...
# ----------------------------------------------------------------------
# TestClefConversion: Test clef to LilyPond conversion.
# ----------------------------------------------------------------------


def test_standard_clefs() -> None:
...
# ----------------------------------------------------------------------
# TestKeyConversion: Test key signature to LilyPond conversion.
# ----------------------------------------------------------------------


def test_major_keys() -> None:
...
# ----------------------------------------------------------------------
# TestTimeConversion: Test time signature to LilyPond conversion.
# ----------------------------------------------------------------------


def test_common_times() -> None:
...
# ----------------------------------------------------------------------
# TestBarlineConversion: Test barline to LilyPond conversion.
# ----------------------------------------------------------------------


def test_standard_barlines() -> None:
...
# ----------------------------------------------------------------------
# TestArticulationConversion: Test articulation to LilyPond conversion.
# ----------------------------------------------------------------------


def test_standard_articulations() -> None:
...
# ----------------------------------------------------------------------
# TestBarRest: Test full-bar rest generation.
# ----------------------------------------------------------------------


def test_standard_rests() -> None:
...
# ----------------------------------------------------------------------
# TestNoteConversion: Test note to LilyPond conversion.
# ----------------------------------------------------------------------


def test_with_tie() -> None:
    """Test note with tie."""
...
def test_with_articulations() -> None:
...
# ----------------------------------------------------------------------
# TestNoteRestConversion: Test NoteRest to LilyPond conversion.
# ----------------------------------------------------------------------


def test_chord_with_tie() -> None:
...
def test_chord_with_articulations() -> None:
...
# ----------------------------------------------------------------------
# TestBarConversion: Test bar to LilyPond conversion.
# ----------------------------------------------------------------------


def test_with_elements() -> None:
...
def test_with_dim_hairpin() -> None:
...
def test_with_slur_and_tuplet() -> None:
...
def test_with_invisible_barline() -> None:
    ...
    bar = Bar(
        ...
        elements=[
            ...
            NoteRest(pos=512, dur=512, notes=[Note(pitch=62)]),  # Note after barline
        ],
    )
    result = _convert_bar(bar, {}, {})
...
# ----------------------------------------------------------------------
# TestStaffConversion: Test staff to LilyPond conversion.
# ----------------------------------------------------------------------


def test_with_instrument() -> None:
...
def test_without_instrument() -> None:
...
# ----------------------------------------------------------------------
# TestMovementConversion: Test movement to LilyPond conversion.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# TestScoreConversion: Test full score to LilyPond conversion.
# ----------------------------------------------------------------------
...
def test_with_all_metadata() -> None:
...
def test_hidden_rest_is_spacer() -> None:
...
def test_multi_movement_layout() -> None:
...
def test_multi_movement_empty_fallback() -> None:
