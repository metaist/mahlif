...
```bash
# get the code
git clone git@github.com:metaist/mahlif.git
cd mahlif
uv sync
...
You can also look at the [unreleased](https://github.com/metaist/mahlif/compare/prod...main) log too.
...
[X.0.1]: https://github.com/metaist/mahlif/compare/X.0.0...X.0.1
...
[Review the release on GitHub](https://github.com/metaist/mahlif/releases). Once published, the `pypi.yaml` workflow will attempt to publish it to PyPI.
